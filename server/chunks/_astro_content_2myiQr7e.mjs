...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DW8WI57D.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/clarity-docs/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_BACKEND_URL": "http://localhost:3000", "PUBLIC_BASE_PATH": "/clarity-docs/", "PUBLIC_SITE_DESCRIPTION": "A premium documentation platform for teams", "PUBLIC_SITE_NAME": "Clarity", "PUBLIC_SITE_URL": "https://alex-migwi.github.io/clarity-docs", "SITE": "https://alex-migwi.github.io/clarity-docs", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Cpsh-ARy.mjs').then(n => n._);
